<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="当前参与人id" prop="openId">
        <el-input
          v-model="queryParams.openId"
          placeholder="请输入当前参与人id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    >
      ...
      <el-table-column label="当前参与人id" align="center" prop="openId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="当前参与人id" prop="openId">
          <el-input v-model="form.openId" placeholder="请输入当前参与人id" />
        </el-form-item>
        <el-form-item label="当前助力人数" prop="helpCount">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm(
          '是否确认删除【请填写功能名称】编号为"' + forwardIds + '"的数据项？'
        )
        .then(function () {
