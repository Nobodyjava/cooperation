<template>
  <div class="app-container">
    <el-form
      ...
      label-width="68px"
    >
      <el-form-item label="审批流程审批人姓名" prop="managerName">
        <el-input
          v-model="queryParams.managerName"
          placeholder="请输入审批流程审批人姓名"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="审批流程审核人联系电话" prop="managerPhone">
        <el-input
          v-model="queryParams.managerPhone"
          placeholder="请输入审批流程审核人联系电话"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="审批流程审核人密码" prop="managerPassword">
        <el-input
          v-model="queryParams.managerPassword"
          placeholder="请输入审批流程审核人密码"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['object:manager:edit']"
          >修改</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['object:manager:remove']"
          >删除</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['object:manager:export']"
          >导出</el-button
        >
      </el-col>
      <right-toolbar
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal
        .confirm(
          '是否确认删除【请填写功能名称】编号为"' + managerIds + '"的数据项？'
        )
        .then(function () {
