<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="核销账号" prop="validatedAccount">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['object:verification:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['object:verification:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['object:verification:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['object:verification:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="verificationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="核销表自增长id" align="center" prop="verificationId" />
      <el-table-column label="活动id" align="center" prop="activityId" />
      <el-table-column label="openid" align="center" prop="openid" />
      <el-table-column label="核销账号" align="center" prop="validatedAccount" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="核销账号" prop="validatedAccount">
          <el-input v-model="form.validatedAccount" placeholder="请输入核销账号" />
        </el-form-item>
      </el-form>
...
<script>
import { listVerification, getVerification, delVerification, addVerification, updateVerification } from "@/api/object/verification";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除【请填写功能名称】编号为"' + verificationIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('object/verification/export', {
        ...this.queryParams
